...
{
    public class CustomerService : BasePagingService, ICustomerService
    {
        ...
        public Task<PageList<Customer>> GetPagedDataAsync(int page, int pageSize = 10, CancellationToken ct = default)
        {
